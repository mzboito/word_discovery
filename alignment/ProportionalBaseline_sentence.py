...
def segment_and_write(ph, fr, output_name):
    #create two lists
...
def print_usage():
    ...
    print "arg1: files list with output names\narg2: unsegmented source (with blank spaces between the symbols)\narg3: aligned target translation\narg3: output directory\n"
